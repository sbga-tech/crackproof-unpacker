...
use crate::report::{GeneratedSemanticClrContainer, ManagedSemanticClrSource};
use crate::unpack::imports::LoaderDiscovery;
...
mod tests {
    ...
    fn discovery() -> LoaderDiscovery {
        crate::unpack::imports::discover_imports_in_image(
            SDDT_MAPPED,
            &source_pe(),
