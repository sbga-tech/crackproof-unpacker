...
fn unchanged_native_profile_does_not_require_sparse_layout() {
    ...
    assert_eq!(
        profile.fingerprint(),
        crate::pipeline::outcome::RecoveredProgram {
            code_transform: crate::pipeline::outcome::CodeTransform::Unchanged,
            startup_kind: crate::pipeline::outcome::StartupKind::I386MsvcStandalone,
...
fn dll_and_managed_recovered_programs_have_no_code_transform() {
    ...
    assert_eq!(
        ...
        crate::pipeline::outcome::CodeTransform::NotApplicable
    );
    assert_eq!(
        native_profile.fingerprint(),
        crate::pipeline::outcome::RecoveredProgram {
            code_transform: crate::pipeline::outcome::CodeTransform::NotApplicable,
            startup_kind: crate::pipeline::outcome::StartupKind::NativeDllEntry,
    ...
    assert_eq!(
        ...
        crate::pipeline::outcome::RecoveredProgram {
            code_transform: crate::pipeline::outcome::CodeTransform::NotApplicable,
            startup_kind: crate::pipeline::outcome::StartupKind::ManagedDll,
            startup_rva: 0,
            handoff_rva: None,
        }
    );
...
fn selects_i386_rol3_only_by_standalone_semantics() {
    ...
    assert_eq!(
        profile.fingerprint(),
        crate::pipeline::outcome::RecoveredProgram {
            code_transform: crate::pipeline::outcome::CodeTransform::PageRvaRol { rotation: 3 },
            startup_kind: crate::pipeline::outcome::StartupKind::I386MsvcStandalone,
            startup_rva: layout.entry,
            handoff_rva: None,
        }
...
fn recovered_program_preserves_semantic_evidence() {
    fn recovered_program(evidence: SemanticEvidence) -> crate::pipeline::outcome::RecoveredProgram {
    ...
    let cases = [
        (
            ...
            crate::pipeline::outcome::StartupKind::I386CrtHandoff,
        ),
        (
            SemanticEvidence::I386MsvcStandalone {
                cookie_rva: 0,
        ...
        (
            ...
            crate::pipeline::outcome::StartupKind::Amd64ImportHandoff,
        ),
        (
            ...
            crate::pipeline::outcome::StartupKind::Amd64MsvcUnwind,
        ),
    ];
