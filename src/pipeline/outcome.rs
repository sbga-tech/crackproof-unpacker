...
/// Provenance for the staged controller's two generated byte maps.
#[derive(Clone, Debug, Eq, PartialEq, Serialize)]
pub struct SelectedStagedController {
...
pub struct DecryptionDetails {
    ...
    pub selected_staged_controller: Option<SelectedStagedController>,
}
